...
class BaseToolCallingAgent:
    ...
    def __init__(self, name: str, role: str, tools: List, max_iterations: int = 5, verbose: bool = True):
        self.name = name
        self.role = role
        self.tools = tools
